<script lang="ts">
	...
	import { AnalysisWindow } from '$lib/components/analysis';
	import { selectedAnalysisTaskId } from '$lib/stores';
...
{#if $user}
	...
	<!-- Analysis Windows -->
	{#if $selectedAnalysisTaskId}
		<AnalysisWindow taskId={$selectedAnalysisTaskId} />
	{/if}
{/if}
