<script lang="ts">
	...
	import { WEBUI_API_BASE_URL, WEBUI_BASE_URL, WEBUI_STATIC_BASE_URL } from '$lib/constants';
				...
				>
					...
					>
						<div class=" self-center flex items-center justify-center size-9">
							<img
								src="{WEBUI_STATIC_BASE_URL}/favicon.png?v=2"
		...
		>
			...
			>
				<div class="pb-1.5">
					...
					<!-- Model Analysis Report Button -->
					<div class="px-1.5 flex justify-center text-gray-800 dark:text-gray-200">
						<a
							id="sidebar-report-button"
							href="/report"
							class="grow flex items-center space-x-3 rounded-2xl px-2.5 py-2 hover:bg-gray-100 dark:hover:bg-gray-900 transition"
							aria-label={$i18n.t('Model Analysis Report')}
						>
							<div class="self-center">
								<svg
									xmlns="http://www.w3.org/2000/svg"
							...
							<div class="flex self-center translate-y-[0.5px]">
								<div class=" self-center text-sm font-primary">{$i18n.t('Model Report')}</div>
							</div>
						</a>
					</div>
				</div>
