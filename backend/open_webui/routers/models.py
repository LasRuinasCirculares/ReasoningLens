...
DEFAULT_MODEL_PLACEHOLDER_SVG = """<svg xmlns='http://www.w3.org/2000/svg' width='120' height='120' viewBox='0 0 120 120' fill='none'><rect width='120' height='120' rx='20' fill='#F3F4F6'/><path d='M60 62c10.493 0 19-8.507 19-19S70.493 24 60 24s-19 8.507-19 19 8.507 19 19 19Zm0 8c-14.36 0-26 10.969-26 24.5a2.5 2.5 0 0 0 2.5 2.5h47a2.5 2.5 0 0 0 2.5-2.5C86 80.969 74.36 70 60 70Z' fill='#9CA3AF'/></svg>"""
...
async def get_model_profile_image(id: str, user=Depends(get_verified_user)):
    ...
    if model:
        ...
        default_path = Path(STATIC_DIR) / "favicon.png"
        if default_path.exists():
            return FileResponse(default_path)
        return Response(
            content=DEFAULT_MODEL_PLACEHOLDER_SVG,
