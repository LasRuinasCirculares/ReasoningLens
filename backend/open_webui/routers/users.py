...
DEFAULT_USER_PLACEHOLDER_SVG = """<svg xmlns='http://www.w3.org/2000/svg' width='120' height='120' viewBox='0 0 120 120' fill='none'><rect width='120' height='120' rx='20' fill='#EEF2FF'/><path d='M60 64c10.493 0 19-8.507 19-19S70.493 26 60 26 41 34.507 41 45s8.507 19 19 19Zm0 8c-14.36 0-26 10.969-26 24.5a2.5 2.5 0 0 0 2.5 2.5h47a2.5 2.5 0 0 0 2.5-2.5C86 82.969 74.36 72 60 72Z' fill='#6366F1'/></svg>"""
        ...
        if user.profile_image_url:
            ...
            if user.profile_image_url.startswith("http"):
                ...
                try:
                    ...
                    pass
        default_path = Path(STATIC_DIR) / "user.png"
        if default_path.exists():
            return FileResponse(default_path)
        return Response(
            content=DEFAULT_USER_PLACEHOLDER_SVG,
